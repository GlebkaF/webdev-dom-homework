...
const fetchPromise = fetch('https://webdev-hw-api.vercel.app/api/v1/aleks-zasimov/comments', {
  method: 'GET',
});
...
const sendCommentToServer = (comment) => {
  fetch('https://webdev-hw-api.vercel.app/api/v1/aleks-zasimov/comments', {
    method: 'POST',
