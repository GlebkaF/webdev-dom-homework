export const initDeleteEvent = ({ listElement, listElementData, initLikeEvent, initRedactorEvent, initAnsverEvent, commentTextareaElement, enterComment, nameInputElement, renderListElement }) => {
